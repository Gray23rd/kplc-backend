...
echo "=== PHASE 5: ENERGY-SAVING RECOMMENDATIONS TEST ==="
echo ""
...
echo "Step 3: Getting energy-saving recommendations..."
curl -s -X GET "http://localhost:5000/api/recommendations/$ACCOUNT_ID" \
  -H "Authorization: Bearer $TOKEN" \
  | python3 -m json.tool
